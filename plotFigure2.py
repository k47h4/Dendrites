...
def plot_boxplot(data,savepath,name):
    fig = plt.figure(figsize = (7.5,9),dpi=80)
    ...
    #ax.set_xticklabels(['100', '150', '200'])
    ...
    #plt.xlim((90,170))
    #plt.ylim((-45,-30))
    plt.ylabel("tau_critical [mV]", fontsize = 'large')
    plt.savefig('%s/tau_critical_boxplot%s.eps'%(savepath,name))   
...
filenames = [#'N_Adfixed20_excs_EI8','N_Adfixed20_excs_EI8_s2','N_Adfixed20_excs_EI8_s3','N_Adfixed20_excs_EI8_s4','N_Adfixed20_excs_EI8_s5','N_Adfixed20_excs_EI8_s6','N_Adfixed20_excs_EI8_s7','N_Adfixed20_excs_EI8_s8','N_Adfixed20_excs_EI8_s9','N_Adfixed20_excs_EI8_s10','N_Adfixed20_excs_s1',
             ...
             #'N_Adfixed20_excd_rangeres','N_Adfixed20_excd_rangeres_s2','N_Adfixed20_excd_rangeres_s3','N_Adfixed20_excd_rangeres_s4','N_Adfixed20_excd_rangeres_s5','N_Adfixed20_excd_rangeres_s6','N_Adfixed20_excd_rangeres_s7','N_Adfixed20_excd_rangeres_s8',
             'N_Adfixed20_excd_rangeres1','N_Adfixed20_excd_rangeres1_s2','N_Adfixed20_excd_rangeres1_s3','N_Adfixed20_excd_rangeres1_s4','N_Adfixed20_excd_rangeres1_s5','N_Adfixed20_excd_rangeres1_s6','N_Adfixed20_excd_rangeres1_s7',#'N_Adfixed20_excd_rangeres_s8',
             #'N_Adfixed20_excs_rangeres','N_Adfixed20_excs_rangeres_s2','N_Adfixed20_excs_rangeres_s3','N_Adfixed20_excs_rangeres_s4','N_Adfixed20_excs_rangeres_s5','N_Adfixed20_excs_rangeres_s6','N_Adfixed20_excs_rangeres_s8','N_Adfixed20_excs_rangeres_s9',
             'N_Adfixed20_excs_rangeres1','N_Adfixed20_excs_rangeres1_s2','N_Adfixed20_excs_rangeres1_s3','N_Adfixed20_excs_rangeres1_s4','N_Adfixed20_excs_rangeres1_s5','N_Adfixed20_excs_rangeres1_s6','N_Adfixed20_excs_rangeres1_s7',#'N_Adfixed20_excs_rangeres1_s8',
             'N_Adfixed20_wDEI_rangeres1','N_Adfixed20_wDEI_rangeres1_s2','N_Adfixed20_wDEI_rangeres1_s3','N_Adfixed20_wDEI_rangeres1_s4',#'N_Adfixed20_wDEI_rangeres_s5','N_Adfixed20_wDEI_rangeres_s6',#'N_Adfixed20_wDEI_rangeres_s7',
             'N_Adfixed20_wEI_rangeres1','N_Adfixed20_wEI_rangeres1_s2','N_Adfixed20_wEI_rangeres1_s3','N_Adfixed20_wEI_rangeres1_s4',#'N_Adfixed20_wEI_rangeres_s5','N_Adfixed20_wEI_rangeres_s6',#'N_Adfixed20_wEI_rangeres_s7',
             ...
             #'N_Adfixed20_etas_rangeres','N_Adfixed20_etas_rangeres_s2','N_Adfixed20_etas_rangeres_s3','N_Adfixed20_etas_rangeres_s4','N_Adfixed20_etas_rangeres_s5','N_Adfixed20_etas_rangeres_s6','250_Adfixed20_etas_rangeres_s7','250_Adfixed20_etas_rangeres_s8','N_Adfixed20_etas_rangeres_s9','N_Adfixed20_etas_rangeres_s10',
             #'N_Adfixed20_etad_rangeres1','N_Adfixed20_etad_rangeres1_s2','N_Adfixed20_etad_rangeres1_s3','N_Adfixed20_etad_rangeres1_s4','N_Adfixed20_etad_rangeres1_s5',#'N_Adfixed20_etad_rangeres1_s6','250_Adfixed20_etad_rangeres_s7','250_Adfixed20_etad_rangeres_s8','N_Adfixed20_etad_rangeres_s9','N_Adfixed20_etad_rangeres_s10',
             #'N_Adfixed20_wEI_EI8','N_Adfixed20_wEI_EI8_s2','N_Adfixed20_wEI_EI8_s3','N_Adfixed20_wEI_EI8_s4',
             #'N_Adfixed20_wDEI_EI8','N_Adfixed20_wDEI_EI8_s2','N_Adfixed20_wDEI_EI8_s3','N_Adfixed20_wDEI_EI8_s4',
             ...
             'N_Adfixed20_inhboth_rangeres1wr','N_Adfixed20_inhboth_rangeres1wr_s2','N_Adfixed20_inhboth_rangeres1wr_s3','N_Adfixed20_inhboth_rangeres1wr_s4','N_Adfixed20_inhboth_rangeres1wr_s5','N_Adfixed20_inhboth_rangeres1wr_s6','N_Adfixed20_inhboth_rangeres1wr_s7','N_Adfixed20_inhboth_rangeres1wr_s8','N_Adfixed20_inhboth_rangeres1wr_s9','N_Adfixed20_inhboth_rangeres1wr_s10',
             'N_Adfixed20_vt_rangeres1wr','N_Adfixed20_vt_rangeres1wr_s2','N_Adfixed20_vt_rangeres1wr_s3','N_Adfixed20_vt_rangeres1wr_s4','N_Adfixed20_vt_rangeres1wr_s5','N_Adfixed20_vt_rangeres1wr_s6','N_Adfixed20_vt_rangeres1wr_s7','N_Adfixed20_vt_rangeres1wr_s8','N_Adfixed20_vt_rangeres1wr_s9','N_Adfixed20_vt_rangeres1wr_s10']
...
values_dict = {
        ...
        'N_Adfixed20_inhboth_rangeres_s5' : np.arange(.8,1.11,.1),
        'N_Adfixed20_inhboth_rangeres_s6' : np.arange(.8,1.11,.1),
        'N_Adfixed20_inhboth_rangeres_s7' : np.arange(.8,1.11,.1),
        'N_Adfixed20_inhboth_rangeres_s8' : np.arange(.8,1.11,.1),
        'N_Adfixed20_inhboth_rangeres1wr' : np.arange(.8,1.11,.1),
        'N_Adfixed20_inhboth_rangeres1wr_s2' : np.arange(.8,1.11,.1),
        'N_Adfixed20_inhboth_rangeres1wr_s3' : np.arange(.8,1.11,.1),
        'N_Adfixed20_inhboth_rangeres1wr_s4' : np.arange(.8,1.11,.1),
        'N_Adfixed20_inhboth_rangeres1wr_s5' : np.arange(.8,1.11,.1),
        'N_Adfixed20_inhboth_rangeres1wr_s6' : np.arange(.8,1.11,.1),
        'N_Adfixed20_inhboth_rangeres1wr_s7' : np.arange(.8,1.11,.1),
        'N_Adfixed20_inhboth_rangeres1wr_s8' : np.arange(.8,1.11,.1),
        'N_Adfixed20_inhboth_rangeres1wr_s9' : np.arange(.8,1.11,.1),
        'N_Adfixed20_inhboth_rangeres1wr_s10' : np.arange(.8,1.11,.1),

        'N_Adfixed20_wEI_rangeres1': np.arange(6.0,8.1,.4)/8.0,
        'N_Adfixed20_wEI_rangeres1_s2': np.arange(6.0,8.1,.4)/8.0,
        'N_Adfixed20_wEI_rangeres1_s3': np.arange(6.0,8.1,.4)/8.0,
        'N_Adfixed20_wEI_rangeres1_s4': np.arange(6.0,8.1,.4)/8.0,

        'N_Adfixed20_wDEI_rangeres1': np.arange(3.0,4.1,.2)/4.0,
        'N_Adfixed20_wDEI_rangeres1_s2': np.arange(3.0,4.1,.2)/4.0,
        'N_Adfixed20_wDEI_rangeres1_s3': np.arange(3.0,4.1,.2)/4.0,
        'N_Adfixed20_wDEI_rangeres1_s4': np.arange(3.0,4.1,.2)/4.0,
        ...
        '250_Adfixed20_etas_rangeres_s7': np.arange(5.0,10.1,1.0)/5.0,
        '250_Adfixed20_etas_rangeres_s8': np.arange(5.0,10.1,1.0)/5.0,
        'N_Adfixed20_etas_rangeres_s9': np.arange(5.0,10.1,1.0)/5.0,
        'N_Adfixed20_etas_rangeres_s10': np.arange(5.0,10.1,1.0)/5.0,
        ...
        '250_Adfixed20_etad_rangeres_s7': np.arange(5.0,10.1,1.0)/5.0,
        '250_Adfixed20_etad_rangeres_s8': np.arange(5.0,10.1,1.0)/5.0,
        'N_Adfixed20_etad_rangeres_s9': np.arange(5.0,10.1,1.0)/5.0,
        'N_Adfixed20_etad_rangeres_s10': np.arange(5.0,10.1,1.0)/5.0,
        ...
        'N_Adfixed20_excd_rangeres_s7': np.arange(.9,1.16,.05),
        'N_Adfixed20_excd_rangeres_s8': np.arange(.9,1.16,.05),

        'N_Adfixed20_excd_rangeres1': np.arange(.9,1.16,.05),
        'N_Adfixed20_excd_rangeres1_s2': np.arange(.9,1.16,.05),
        'N_Adfixed20_excd_rangeres1_s3': np.arange(.9,1.16,.05),
        'N_Adfixed20_excd_rangeres1_s4': np.arange(.9,1.16,.05),
        'N_Adfixed20_excd_rangeres1_s5': np.arange(.9,1.16,.05),
        'N_Adfixed20_excd_rangeres1_s6': np.arange(.9,1.16,.05),
        'N_Adfixed20_excd_rangeres1_s7': np.arange(.9,1.16,.05),
        ...
        'N_Adfixed20_excs_rangeres_s7': np.arange(.9,1.16,.05),
        'N_Adfixed20_excs_rangeres_s8': np.arange(.9,1.16,.05),
        'N_Adfixed20_excs_rangeres_s9': np.arange(.9,1.16,.05),

        'N_Adfixed20_excs_rangeres1': np.arange(.9,1.16,.05),
        'N_Adfixed20_excs_rangeres1_s2': np.arange(.9,1.16,.05),
        'N_Adfixed20_excs_rangeres1_s3': np.arange(.9,1.16,.05),
        'N_Adfixed20_excs_rangeres1_s4': np.arange(.9,1.16,.05),
        'N_Adfixed20_excs_rangeres1_s5': np.arange(.9,1.16,.05),
        'N_Adfixed20_excs_rangeres1_s6': np.arange(.9,1.16,.05),
        'N_Adfixed20_excs_rangeres1_s7': np.arange(.9,1.16,.05),
        'N_Adfixed20_excs_rangeres1_s8': np.arange(.9,1.16,.05),
        ...
        'N_Adfixed20_vt_rangeres1wr': np.arange(-52.5,-49.9,.5)/-50,
        'N_Adfixed20_vt_rangeres1wr_s2': np.arange(-52.5,-49.9,.5)/-50,
        'N_Adfixed20_vt_rangeres1wr_s3': np.arange(-52.5,-49.9,.5)/-50,
        'N_Adfixed20_vt_rangeres1wr_s4': np.arange(-52.5,-49.9,.5)/-50,
        'N_Adfixed20_vt_rangeres1wr_s5': np.arange(-52.5,-49.9,.5)/-50,
        'N_Adfixed20_vt_rangeres1wr_s6': np.arange(-52.5,-49.9,.5)/-50,
        'N_Adfixed20_vt_rangeres1wr_s7': np.arange(-52.5,-49.9,.5)/-50,
        'N_Adfixed20_vt_rangeres1wr_s8': np.arange(-52.5,-49.9,.5)/-50,
        'N_Adfixed20_vt_rangeres1wr_s9': np.arange(-52.5,-49.9,.5)/-50,
        'N_Adfixed20_vt_rangeres1wr_s10': np.arange(-52.5,-49.9,.5)/-50,
...
tau_dict = {
        ...
        '250_Adfixed20_etas_rangeres_s7': np.arange(10.0,30.1,1.0),
        '250_Adfixed20_etas_rangeres_s8': np.arange(10.0,30.1,1.0),
        'N_Adfixed20_etas_rangeres_s9': np.arange(10.0,25.1,1.0),
        'N_Adfixed20_etas_rangeres_s10': np.arange(10.0,25.1,1.0),
        ...
        '250_Adfixed20_etad_rangeres_s7': np.arange(10.0,30.1,1.0),
        '250_Adfixed20_etad_rangeres_s8': np.arange(10.0,30.1,1.0),
        'N_Adfixed20_etad_rangeres_s9': np.arange(10.0,25.1,1.0),
        'N_Adfixed20_etad_rangeres_s10': np.arange(10.0,25.1,1.0),
        ...
        'N_Adfixed20_excd_rangeres_s7': np.arange(5.0,30.0,1.0),
        'N_Adfixed20_excd_rangeres_s8': np.arange(5.0,30.0,1.0),

        'N_Adfixed20_excd_rangeres1': np.arange(5.0,30.0,1.0),
        'N_Adfixed20_excd_rangeres1_s2': np.arange(5.0,30.0,1.0),
        'N_Adfixed20_excd_rangeres1_s3': np.arange(5.0,30.0,1.0),
        'N_Adfixed20_excd_rangeres1_s4': np.arange(5.0,30.0,1.0),
        'N_Adfixed20_excd_rangeres1_s5': np.arange(5.0,31.0,1.0),
        'N_Adfixed20_excd_rangeres1_s6': np.arange(5.0,31.0,1.0),
        'N_Adfixed20_excd_rangeres1_s7': np.arange(5.0,31.0,1.0),
        ...
        'N_Adfixed20_excs_rangeres_s7': np.arange(5.0,30.0,1.0),
        'N_Adfixed20_excs_rangeres_s8': np.arange(5.0,30.0,1.0),
        'N_Adfixed20_excs_rangeres_s9': np.arange(5.0,30.0,1.0),

        'N_Adfixed20_excs_rangeres1': np.arange(5.0,31.0,1.0),
        'N_Adfixed20_excs_rangeres1_s2': np.arange(5.0,31.0,1.0),
        'N_Adfixed20_excs_rangeres1_s3': np.arange(5.0,31.0,1.0),
        'N_Adfixed20_excs_rangeres1_s4': np.arange(5.0,31.0,1.0),
        'N_Adfixed20_excs_rangeres1_s5': np.arange(5.0,31.0,1.0),
        'N_Adfixed20_excs_rangeres1_s6': np.arange(5.0,31.0,1.0),
        'N_Adfixed20_excs_rangeres1_s7': np.arange(5.0,31.0,1.0),
        'N_Adfixed20_excs_rangeres1_s8': np.arange(5.0,31.0,1.0),
        
        'N_Adfixed20_wDEI_rangeres1': np.arange(5.0,30.0,1.0),
        'N_Adfixed20_wDEI_rangeres1_s2': np.arange(5.0,30.0,1.0),
        'N_Adfixed20_wDEI_rangeres1_s3': np.arange(5.0,30.0,1.0),
        'N_Adfixed20_wDEI_rangeres1_s4': np.arange(5.0,30.0,1.0),

        'N_Adfixed20_wEI_rangeres1': np.arange(5.0,30.0,1.0),
        'N_Adfixed20_wEI_rangeres1_s2': np.arange(5.0,30.0,1.0),
        'N_Adfixed20_wEI_rangeres1_s3': np.arange(5.0,30.0,1.0),
        'N_Adfixed20_wEI_rangeres1_s4': np.arange(5.0,30.0,1.0),
        ...
        'N_Adfixed20_inhboth_rangeres_s5': np.arange(5.0,30.1,1.0),
        'N_Adfixed20_inhboth_rangeres_s6': np.arange(5.0,30.1,1.0),
        'N_Adfixed20_inhboth_rangeres_s7': np.arange(5.0,30.1,1.0),
        'N_Adfixed20_inhboth_rangeres_s8': np.arange(5.0,30.1,1.0),

        'N_Adfixed20_inhboth_rangeres1wr': np.arange(10.0,30.1,1.0),
        'N_Adfixed20_inhboth_rangeres1wr_s2': np.arange(10.0,30.1,1.0),
        'N_Adfixed20_inhboth_rangeres1wr_s3': np.arange(10.0,30.1,1.0),
        'N_Adfixed20_inhboth_rangeres1wr_s4': np.arange(10.0,30.1,1.0),
        'N_Adfixed20_inhboth_rangeres1wr_s5': np.arange(10.0,30.1,1.0),
        'N_Adfixed20_inhboth_rangeres1wr_s6': np.arange(10.0,30.1,1.0),
        'N_Adfixed20_inhboth_rangeres1wr_s7': np.arange(10.0,30.1,1.0),
        'N_Adfixed20_inhboth_rangeres1wr_s8': np.arange(10.0,30.1,1.0),
        'N_Adfixed20_inhboth_rangeres1wr_s9': np.arange(10.0,30.1,1.0),
        'N_Adfixed20_inhboth_rangeres1wr_s10': np.arange(10.0,30.1,1.0),
        ...
        'N_Adfixed20_vt_rangeres1wr': np.arange(5.0,25.1,1.0),
        'N_Adfixed20_vt_rangeres1wr_s2': np.arange(5.0,25.1,1.0),
        'N_Adfixed20_vt_rangeres1wr_s3': np.arange(5.0,25.1,1.0),
        'N_Adfixed20_vt_rangeres1wr_s4': np.arange(5.0,25.1,1.0),
        'N_Adfixed20_vt_rangeres1wr_s5': np.arange(5.0,25.1,1.0),
        'N_Adfixed20_vt_rangeres1wr_s6': np.arange(5.0,25.1,1.0),
        'N_Adfixed20_vt_rangeres1wr_s7': np.arange(5.0,25.1,1.0),
        'N_Adfixed20_vt_rangeres1wr_s8': np.arange(5.0,25.1,1.0),
        'N_Adfixed20_vt_rangeres1wr_s9': np.arange(5.0,25.1,1.0),
        'N_Adfixed20_vt_rangeres1wr_s10': np.arange(5.0,25.1,1.0),
...
for filename in filenames:
    ...
    ef_list.append(explosion_factor)
    ...
    if filename == 'N_Adfixed20_excboth_rangeres_s4':
        xlabel = 'excitability'
    elif filename == 'N_Adfixed20_etaboth_rangeres_s4':
        xlabel = 'learning rate'
    elif filename == 'N_Adfixed20_inhboth_rangeres_s4':
        xlabel = 'inhibition [nS]'
    else: 
        xlabel = 'modulation'

    plt.figure(figsize=(4,4))#(4,2.8))
    ax = subplot(111)
    plt.hist(explosion_factor.T,bins=20)#, interpolation='nearest', origin='lower',vmin=1,vmax=5.1)#np.max(explosion_factor))#, c=performance_binary)
    #plt.ylabel('%s [sec]'%param1)
    plt.xlabel('explosion factor')
    plt.tight_layout()
    plt.savefig('%s/histexplosionfactor_critical%s%d.pdf'%(savepath,identifier,i))
    ...
    plt.xlabel(xlabel)
    plt.xticks(np.arange(0,len(param2_values),2),param2_values[::2])
    plt.yticks(np.arange(0,len(param1_values),5),param1_values.astype(int)[::5])
    cb = plt.colorbar(orientation='horizontal')
...
#raise ValueError
plt.figure(figsize=(1.5,1.5))#(4,2.8))
ax = subplot(111)
plt.hist(np.array(ef_list),bins=200,rasterized=True, color=['k']*62)#, interpolation='nearest', origin='lower',vmin=1,vmax=5.1)#np.max(explosion_factor))#, c=performance_binary)
#plt.ylabel('%s [sec]'%param1)
plt.xlim(0,2.5)
...
ax.xaxis.set_ticks_position('bottom')
plt.tight_layout()
plt.savefig('%s/histzoomexplosionfactor_critical%s.pdf'%(savepath,identifier))


plt.figure(figsize=(3.5,2.8))#(4,2.8))
ax = subplot(111)
plt.hist(np.array(ef_list),bins=200,rasterized=True,color=['k']*62)#, interpolation='nearest', origin='lower',vmin=1,vmax=5.1)#np.max(explosion_factor))#, c=performance_binary)
#plt.ylabel('%s [sec]'%param1)
#plt.xlim(0,2.5)
...
plt.xlabel('explosion factor')
plt.tight_layout()
plt.savefig('%s/histexplosionfactor_critical%s.pdf'%(savepath,identifier))
print('+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++')
print(savepath)
...
#Diff_eta.append(tau_critical_dict['N_Adfixed20_etad_rangeres1'] - tau_critical_dict['N_Adfixed20_etas_rangeres1'])
#Diff_eta.append(tau_critical_dict['N_Adfixed20_etad_rangeres1_s2'] - tau_critical_dict['N_Adfixed20_etas_rangeres1_s2'])
#Diff_eta.append(tau_critical_dict['N_Adfixed20_etad_rangeres1_s3'] - tau_critical_dict['N_Adfixed20_etas_rangeres1_s3'])
#Diff_eta.append(tau_critical_dict['N_Adfixed20_etad_rangeres1_s4'] - tau_critical_dict['N_Adfixed20_etas_rangeres1_s4'])
#Diff_eta.append(tau_critical_dict['N_Adfixed20_etad_rangeres1_s5'] - tau_critical_dict['N_Adfixed20_etas_rangeres1_s5'])
#Diff_eta.append(tau_critical_dict['N_Adfixed20_etad_rangeres1_s6'] - tau_critical_dict['N_Adfixed20_etas_rangeres1_s6'])
#Diff_eta.append(tau_critical_dict['250_Adfixed20_etad_rangeres1_s7'] - tau_critical_dict['250_Adfixed20_etas_rangeres1_s7'])
#Diff_eta.append(tau_critical_dict['250_Adfixed20_etad_rangeres1_s8'] - tau_critical_dict['250_Adfixed20_etas_rangeres1_s8'])
#Diff_eta.append(tau_critical_dict['N_Adfixed20_etad_rangeres1_s9'] - tau_critical_dict['N_Adfixed20_etas_rangeres1_s9'])
#Diff_eta.append(tau_critical_dict['N_Adfixed20_etad_rangeres1_s10'] - tau_critical_dict['N_Adfixed20_etas_rangeres1_s10'])

    
Diff_exc = []
Diff_exc.append(tau_critical_dict['N_Adfixed20_excd_rangeres1'] - tau_critical_dict['N_Adfixed20_excs_rangeres1'])
Diff_exc.append(tau_critical_dict['N_Adfixed20_excd_rangeres1_s2'] - tau_critical_dict['N_Adfixed20_excs_rangeres1_s2'])
Diff_exc.append(tau_critical_dict['N_Adfixed20_excd_rangeres1_s3'] - tau_critical_dict['N_Adfixed20_excs_rangeres1_s3'])
Diff_exc.append(tau_critical_dict['N_Adfixed20_excd_rangeres1_s4'] - tau_critical_dict['N_Adfixed20_excs_rangeres1_s4'])
Diff_exc.append(tau_critical_dict['N_Adfixed20_excd_rangeres1_s5'] - tau_critical_dict['N_Adfixed20_excs_rangeres1_s5'])
Diff_exc.append(tau_critical_dict['N_Adfixed20_excd_rangeres1_s6'] - tau_critical_dict['N_Adfixed20_excs_rangeres1_s6'])
Diff_exc.append(tau_critical_dict['N_Adfixed20_excd_rangeres1_s7'] - tau_critical_dict['N_Adfixed20_excs_rangeres1_s7'])
#Diff_exc.append(tau_critical_dict['N_Adfixed20_excd_rangeres1_s8'] - tau_critical_dict['N_Adfixed20_excs_rangeres1_s8'])

Diff_inh = []
Diff_inh.append(tau_critical_dict['N_Adfixed20_wDEI_rangeres1'] - tau_critical_dict['N_Adfixed20_wEI_rangeres1'])
Diff_inh.append(tau_critical_dict['N_Adfixed20_wDEI_rangeres1_s2'] - tau_critical_dict['N_Adfixed20_wEI_rangeres1_s2'])
Diff_inh.append(tau_critical_dict['N_Adfixed20_wDEI_rangeres1_s3'] - tau_critical_dict['N_Adfixed20_wEI_rangeres1_s3'])
Diff_inh.append(tau_critical_dict['N_Adfixed20_wDEI_rangeres1_s4'] - tau_critical_dict['N_Adfixed20_wEI_rangeres1_s4'])
...
j = 0
#legendlabels = ['learning rate','excitability', 'inhibition']#,'eta','etad','etas','wEI','wDEI','vt']

#tsplot(a1,values_dict['N_Adfixed20_etad_rangeres'],np.mean(Diff_eta.T,1),np.std(Diff_eta.T,1),color=cmaps.magma(.3))
#plt.hlines(0,1,1.15, colors='k', linestyles='dotted')#, label='', *, data=None, **kwargs)
a1.axhline(y=0, linestyle='dotted',color='k')
a1.set_ylabel('difference in critical tau [nS]')
a1.set_xlabel('change in learning rate')
a1.set_ylim(-5,10)

tsplot(a2,values_dict['N_Adfixed20_excd_rangeres'],np.mean(Diff_exc.T,1),np.std(Diff_exc.T,1),color=cmaps.magma(.7))
a2.axhline(y=0, linestyle='dotted', color='k')
#plt.hlines(0,1,1.15, colors='k', linestyles='dotted')#, label='', *, data=None, **kwargs)
a2.set_xlabel('change in excitability')
a2.set_xlim(1,1.15)
a2.set_ylim(-5,10)

#subplot(313)
#tsplot(a1,values_dict['N_Adfixed20_wDEI_rangeres_s1'],np.mean(Diff_inh.T,1),np.std(Diff_inh.T,1),color=cmaps.viridis(.5))
...
plt.savefig('%s/Diff_all%s.pdf'%(savepath,identifier), bbox_extra_artists=(lgd,), bbox_inches='tight',format='pdf', transparent=True)
...
#tsplot(a1,values_dict['N_Adfixed20_etad_rangeres'],np.mean(Diff_eta.T,1),np.std(Diff_eta.T,1))
#plt.plot(values_dict['N_Adfixed20_etad_EI8highres'],Diff_eta)
#a1.get_xaxis().set_visible(True)
#a1.get_yaxis().set_visible(True)
#tsplot(a1,values_dict['N_Adfixed20_excs_EI8'],D_mean_dict['N_Adfixed20_excs_EI8'],D_std_dict['N_Adfixed20_excs_EI8'])
...
#plt.tight_layout()
#print('%s/tau_critical_means%s.pdf'%(savepath,identifier))
#plt.savefig('%s/Diff_eta%s.pdf'%(savepath,identifier), bbox_extra_artists=(lgd,), bbox_inches='tight',format='pdf', transparent=True)


fig, (a1) = plt.subplots(1,1,figsize=(5,3))
j = 0
#legendlabels = ['exc dendrite','exc soma', 'exc both']#,'eta','etad','etas','wEI','wDEI','vt']
tsplot(a1,values_dict['N_Adfixed20_excd_rangeres'],np.mean(Diff_exc.T,1),np.std(Diff_exc.T,1))
#plt.plot(values_dict['N_Adfixed20_etad_EI8highres'],Diff_eta)
...
plt.tight_layout()
print('%s/tau_critical_means%s.pdf'%(savepath,identifier))
plt.savefig('%s/Diff_exc%s.pdf'%(savepath,identifier), bbox_extra_artists=(lgd,), bbox_inches='tight',format='pdf', transparent=True)


fig, (a1) = plt.subplots(1,1,figsize=(5,3))
j = 0
#legendlabels = ['exc dendrite','exc soma', 'exc both']#,'eta','etad','etas','wEI','wDEI','vt']
tsplot(a1,values_dict['N_Adfixed20_wDEI_rangeres1'],np.mean(Diff_inh.T,1),np.std(Diff_inh.T,1))
#plt.plot(values_dict['N_Adfixed20_etad_EI8highres'],Diff_eta)
...
N_exc = np.array([tau_critical_dict['N_Adfixed20_excboth_rangeres1wr'],tau_critical_dict['N_Adfixed20_excboth_rangeres1wr_s2'],tau_critical_dict['N_Adfixed20_excboth_rangeres1wr_s3'],tau_critical_dict['N_Adfixed20_excboth_rangeres1wr_s4'],tau_critical_dict['N_Adfixed20_excboth_rangeres1wr_s5'],tau_critical_dict['N_Adfixed20_excboth_rangeres1wr_s6'],tau_critical_dict['N_Adfixed20_excboth_rangeres1wr_s7'],tau_critical_dict['N_Adfixed20_excboth_rangeres1wr_s8'],tau_critical_dict['N_Adfixed20_excboth_rangeres1wr_s9'],tau_critical_dict['N_Adfixed20_excboth_rangeres1wr_s10']])
#N_excd = np.array([tau_critical_dict['N_Adfixed20_excd_rangeres'],tau_critical_dict['N_Adfixed20_excd_rangeres_s2'],tau_critical_dict['N_Adfixed20_excd_rangeres_s3'],tau_critical_dict['N_Adfixed20_excd_rangeres_s4'],tau_critical_dict['N_Adfixed20_excd_rangeres_s5'],tau_critical_dict['N_Adfixed20_excd_rangeres_s6'],tau_critical_dict['N_Adfixed20_excd_rangeres_s7']])#,tau_critical_dict['N_Adfixed20_excd_rangeres_s8']])
N_excd1 = np.array([tau_critical_dict['N_Adfixed20_excd_rangeres1'],tau_critical_dict['N_Adfixed20_excd_rangeres1_s2'],tau_critical_dict['N_Adfixed20_excd_rangeres1_s3'],tau_critical_dict['N_Adfixed20_excd_rangeres1_s4'],tau_critical_dict['N_Adfixed20_excd_rangeres1_s5'],tau_critical_dict['N_Adfixed20_excd_rangeres1_s6'],tau_critical_dict['N_Adfixed20_excd_rangeres1_s7']])#,tau_critical_dict['N_Adfixed20_excd_rangeres_s8']])
#N_excs = np.array([tau_critical_dict['N_Adfixed20_excs_rangeres'],tau_critical_dict['N_Adfixed20_excs_rangeres_s2'],tau_critical_dict['N_Adfixed20_excs_rangeres_s3'],tau_critical_dict['N_Adfixed20_excs_rangeres_s4'],tau_critical_dict['N_Adfixed20_excs_rangeres_s5'],tau_critical_dict['N_Adfixed20_excs_rangeres_s6'],tau_critical_dict['N_Adfixed20_excs_rangeres_s8'],tau_critical_dict['N_Adfixed20_excs_rangeres_s9']])#,tau_critical_dict['N_Adfixed20_excs_rangeres_s7'],tau_critical_dict['N_Adfixed20_excs_rangeres_s8'],tau_critical_dict['N_Adfixed20_excs_rangeres_s9'],tau_critical_dict['N_Adfixed20_excs_rangeres_s10']])
N_excs1 = np.array([tau_critical_dict['N_Adfixed20_excs_rangeres1'],tau_critical_dict['N_Adfixed20_excs_rangeres1_s2'],tau_critical_dict['N_Adfixed20_excs_rangeres1_s3'],tau_critical_dict['N_Adfixed20_excs_rangeres1_s4'],tau_critical_dict['N_Adfixed20_excs_rangeres1_s5'],tau_critical_dict['N_Adfixed20_excs_rangeres1_s6'],tau_critical_dict['N_Adfixed20_excs_rangeres1_s7']])#,tau_critical_dict['N_Adfixed20_excs_rangeres_s8']])#,tau_critical_dict['N_Adfixed20_excs_rangeres_s7'],tau_critical_dict['N_Adfixed20_excs_rangeres_s8'],tau_critical_dict['N_Adfixed20_excs_rangeres_s9'],tau_critical_dict['N_Adfixed20_excs_rangeres_s10']])
...
N_wEI = np.array([tau_critical_dict['N_Adfixed20_wEI_rangeres1'],tau_critical_dict['N_Adfixed20_wEI_rangeres1_s2'],tau_critical_dict['N_Adfixed20_wEI_rangeres1_s3'],tau_critical_dict['N_Adfixed20_wEI_rangeres1_s4']])
N_wDEI = np.array([tau_critical_dict['N_Adfixed20_wDEI_rangeres1'],tau_critical_dict['N_Adfixed20_wDEI_rangeres1_s2'],tau_critical_dict['N_Adfixed20_wDEI_rangeres1_s3'],tau_critical_dict['N_Adfixed20_wDEI_rangeres1_s4']])
#N_wINH = np.array([tau_critical_dict['N_Adfixed20_inh_hr'],tau_critical_dict['N_Adfixed20_inh_hr_s2'],tau_critical_dict['N_Adfixed20_inh_hr_s3'],tau_critical_dict['N_Adfixed20_inh_hr_s4']])


N_vt = np.array([tau_critical_dict['N_Adfixed20_vt_rangeres1wr'],tau_critical_dict['N_Adfixed20_vt_rangeres1wr_s2'],tau_critical_dict['N_Adfixed20_vt_rangeres1wr_s3']])



for i in range(len(N_excs1[0])):
    D_list = []
    S_list = []
    for j in range(len(N_excs1)):
        D_list.append(N_excd1[j][i])
        S_list.append(N_excs1[j][i])
        
        print(j)
        print(N_excs1[j][i])
        print(N_excd1[j][i])
    print(i)
    print(stats.ttest_ind(D_list, S_list, axis=0, equal_var=True, nan_policy='propagate'))
    #print(stats.ttest_ind(D_list, S_list, axis=1, equal_var=True, nan_policy='propagate'))
...
D_exc = np.array([dend_weight_change_dict['N_Adfixed20_excboth_rangeres1wr'],dend_weight_change_dict['N_Adfixed20_excboth_rangeres1wr_s2'],dend_weight_change_dict['N_Adfixed20_excboth_rangeres1wr_s3'],dend_weight_change_dict['N_Adfixed20_excboth_rangeres1wr_s4'],dend_weight_change_dict['N_Adfixed20_excboth_rangeres1wr_s5'],dend_weight_change_dict['N_Adfixed20_excboth_rangeres1wr_s6'],dend_weight_change_dict['N_Adfixed20_excboth_rangeres1wr_s7'],dend_weight_change_dict['N_Adfixed20_excboth_rangeres1wr_s8'],dend_weight_change_dict['N_Adfixed20_excboth_rangeres1wr_s9'],dend_weight_change_dict['N_Adfixed20_excboth_rangeres1wr_s10']])
#D_excd = np.array([dend_weight_change_dict['N_Adfixed20_excd_rangeres'],dend_weight_change_dict['N_Adfixed20_excd_rangeres_s2'],dend_weight_change_dict['N_Adfixed20_excd_rangeres_s3'],dend_weight_change_dict['N_Adfixed20_excd_rangeres_s4'],dend_weight_change_dict['N_Adfixed20_excd_rangeres1_s5'],dend_weight_change_dict['N_Adfixed20_excd_rangeres1_s6'],dend_weight_change_dict['N_Adfixed20_excd_rangeres1_s7']])#,dend_weight_change_dict['N_Adfixed20_excd_rangeres_s8']])
D_excd1 = np.array([dend_weight_change_dict['N_Adfixed20_excd_rangeres1'],dend_weight_change_dict['N_Adfixed20_excd_rangeres1_s2'],dend_weight_change_dict['N_Adfixed20_excd_rangeres1_s3'],dend_weight_change_dict['N_Adfixed20_excd_rangeres1_s4'],dend_weight_change_dict['N_Adfixed20_excd_rangeres1_s5'],dend_weight_change_dict['N_Adfixed20_excd_rangeres1_s6'],dend_weight_change_dict['N_Adfixed20_excd_rangeres1_s7']])#,dend_weight_change_dict['N_Adfixed20_excd_rangeres_s8']])
#D_excs = np.array([dend_weight_change_dict['N_Adfixed20_excs_rangeres'],dend_weight_change_dict['N_Adfixed20_excs_rangeres_s2'],dend_weight_change_dict['N_Adfixed20_excs_rangeres_s3'],dend_weight_change_dict['N_Adfixed20_excs_rangeres_s4'],dend_weight_change_dict['N_Adfixed20_excs_rangeres_s5'],dend_weight_change_dict['N_Adfixed20_excs_rangeres_s6'],dend_weight_change_dict['N_Adfixed20_excs_rangeres_s8'],dend_weight_change_dict['N_Adfixed20_excs_rangeres_s9']])#,dend_weight_change_dict['N_Adfixed20_excs_rangeres_s7'],dend_weight_change_dict['N_Adfixed20_excs_rangeres_s8']])
D_excs1 = np.array([dend_weight_change_dict['N_Adfixed20_excs_rangeres1'],dend_weight_change_dict['N_Adfixed20_excs_rangeres1_s2'],dend_weight_change_dict['N_Adfixed20_excs_rangeres1_s3'],dend_weight_change_dict['N_Adfixed20_excs_rangeres1_s4'],dend_weight_change_dict['N_Adfixed20_excs_rangeres1_s5'],dend_weight_change_dict['N_Adfixed20_excs_rangeres1_s6'],dend_weight_change_dict['N_Adfixed20_excs_rangeres1_s7']])#,dend_weight_change_dict['N_Adfixed20_excs_rangeres_s9']])#,dend_weight_change_dict['N_Adfixed20_excs_rangeres_s7'],dend_weight_change_dict['N_Adfixed20_excs_rangeres_s8']])


#Dp_excd = np.array([dend_weight_pot_dict['N_Adfixed20_excd_rangeres'],dend_weight_pot_dict['N_Adfixed20_excd_rangeres_s2'],dend_weight_pot_dict['N_Adfixed20_excd_rangeres_s3'],dend_weight_pot_dict['N_Adfixed20_excd_rangeres_s4'],dend_weight_change_dict['N_Adfixed20_excd_rangeres1_s5'],dend_weight_change_dict['N_Adfixed20_excd_rangeres1_s6'],dend_weight_change_dict['N_Adfixed20_excd_rangeres1_s7']])#,dend_weight_change_dict['N_Adfixed20_excd_rangeres_s8']])
Dp_excd1 = np.array([dend_weight_pot_dict['N_Adfixed20_excd_rangeres1'],dend_weight_pot_dict['N_Adfixed20_excd_rangeres1_s2'],dend_weight_pot_dict['N_Adfixed20_excd_rangeres1_s3'],dend_weight_pot_dict['N_Adfixed20_excd_rangeres1_s4'],dend_weight_change_dict['N_Adfixed20_excd_rangeres1_s5'],dend_weight_change_dict['N_Adfixed20_excd_rangeres1_s6'],dend_weight_change_dict['N_Adfixed20_excd_rangeres1_s7']])#,dend_weight_change_dict['N_Adfixed20_excd_rangeres_s8']])
Dp_excs1 = np.array([dend_weight_pot_dict['N_Adfixed20_excs_rangeres1'],dend_weight_pot_dict['N_Adfixed20_excs_rangeres1_s2'],dend_weight_pot_dict['N_Adfixed20_excs_rangeres1_s3'],dend_weight_pot_dict['N_Adfixed20_excs_rangeres1_s4'],dend_weight_change_dict['N_Adfixed20_excs_rangeres1_s5'],dend_weight_change_dict['N_Adfixed20_excs_rangeres1_s6'],dend_weight_change_dict['N_Adfixed20_excs_rangeres1_s7']])#,dend_weight_change_dict['N_Adfixed20_excd_rangeres_s8']])
#D_eta = np.array([dend_weight_change_dict['N_Adfixed20_etaboth_EI8highres'],dend_weight_change_dict['N_Adfixed20_etaboth_EI8highres_s2'],dend_weight_change_dict['N_Adfixed20_etaboth_EI8highres_s4']])
...
#D_etad_rangeres = np.array([dend_weight_change_dict['N_Adfixed20_etad_rangeres'],dend_weight_change_dict['N_Adfixed20_etad_rangeres_s2'],dend_weight_change_dict['N_Adfixed20_etad_rangeres_s3'],dend_weight_change_dict['N_Adfixed20_etad_rangeres_s4'],dend_weight_change_dict['N_Adfixed20_etad_rangeres_s5'],dend_weight_change_dict['N_Adfixed20_etad_rangeres_s6'],dend_weight_change_dict['250_Adfixed20_etad_rangeres_s7'],dend_weight_change_dict['250_Adfixed20_etad_rangeres_s8'],dend_weight_change_dict['N_Adfixed20_etad_rangeres_s9'],dend_weight_change_dict['N_Adfixed20_etad_rangeres_s10']])
#D_etas_rangeres = np.array([dend_weight_change_dict['N_Adfixed20_etas_rangeres'],dend_weight_change_dict['N_Adfixed20_etas_rangeres_s2'],dend_weight_change_dict['N_Adfixed20_etas_rangeres_s3'],dend_weight_change_dict['N_Adfixed20_etas_rangeres_s4'],dend_weight_change_dict['N_Adfixed20_etas_rangeres_s5'],dend_weight_change_dict['N_Adfixed20_etas_rangeres_s6'],dend_weight_change_dict['250_Adfixed20_etas_rangeres_s7'],dend_weight_change_dict['250_Adfixed20_etas_rangeres_s8'],dend_weight_change_dict['N_Adfixed20_etas_rangeres_s9'],dend_weight_change_dict['N_Adfixed20_etas_rangeres_s10']])
#D_etaboth_rangeres = np.array([dend_weight_change_dict['N_Adfixed20_etaboth_rangeres'],dend_weight_change_dict['N_Adfixed20_etaboth_rangeres_s2'],dend_weight_change_dict['N_Adfixed20_etaboth_rangeres_s3'],dend_weight_change_dict['N_Adfixed20_etaboth_rangeres_s4'],dend_weight_change_dict['N_Adfixed20_etaboth_rangeres_s5'],dend_weight_change_dict['N_Adfixed20_etaboth_rangeres_s6']])
...
D_wEI = np.array([dend_weight_change_dict['N_Adfixed20_wEI_rangeres1'],dend_weight_change_dict['N_Adfixed20_wEI_rangeres1_s2'],dend_weight_change_dict['N_Adfixed20_wEI_rangeres1_s3'],dend_weight_change_dict['N_Adfixed20_wEI_rangeres1_s4']])
D_wDEI = np.array([dend_weight_change_dict['N_Adfixed20_wDEI_rangeres1'],dend_weight_change_dict['N_Adfixed20_wDEI_rangeres1_s2'],dend_weight_change_dict['N_Adfixed20_wDEI_rangeres1_s3'],dend_weight_change_dict['N_Adfixed20_wDEI_rangeres1_s4']])
#D_wINH = np.array([dend_weight_change_dict['N_Adfixed20_inh_hr'],dend_weight_change_dict['N_Adfixed20_inh_hr_s2'],dend_weight_change_dict['N_Adfixed20_inh_hr_s3'],dend_weight_change_dict['N_Adfixed20_inh_hr_s4']])
...
mean_dict = {}
std_dict = {}
mean_dict['N_Adfixed20_excboth_rangeres1wr'] = np.nanmean(N_exc,0) #
#mean_dict['N_Adfixed20_excd_rangeres'] = np.nanmean(N_excd,0) #
#mean_dict['N_Adfixed20_excs_rangeres'] = np.nanmean(N_excs,0) #

mean_dict['N_Adfixed20_excs_rangeres1'] = np.nanmean(N_excs1,0) #
mean_dict['N_Adfixed20_excd_rangeres1'] = np.nanmean(N_excd1,0) #
...
#mean_dict['N_Adfixed20_etaboth_rangeres'] = np.nanmean(N_etaboth_rangeres,0) 

#mean_dict['N_Adfixed20_wEI_EI8'] = np.nanmean(N_wEI,0) 
#mean_dict['N_Adfixed20_wDEI_highres'] = np.nanmean(N_wDEI,0) 
mean_dict['N_Adfixed20_wEI_rangeres1'] = np.nanmean(N_wEI,0) 
mean_dict['N_Adfixed20_wDEI_rangeres1'] = np.nanmean(N_wDEI,0) 
#mean_dict['N_Adfixed20_inh_hr'] = np.nanmean(N_wINH,0) 

#mean_dict['N_Adfixed20_vt_EI8'] = np.nanmean(N_vt,0) #

std_dict['N_Adfixed20_excboth_rangeres1wr'] = np.nanstd(N_exc,0) 
#std_dict['N_Adfixed20_excd_rangeres'] = np.nanstd(N_excd,0) 
std_dict['N_Adfixed20_excd_rangeres1'] = np.nanstd(N_excd1,0) 
#std_dict['N_Adfixed20_excs_rangeres'] = np.nanstd(N_excs,0) 
std_dict['N_Adfixed20_excs_rangeres1'] = np.nanstd(N_excs1,0) 
...
#std_dict['N_Adfixed20_etaboth_rangeres'] = np.nanstd(N_etaboth_rangeres,0) 
...
std_dict['N_Adfixed20_wEI_rangeres1'] = np.nanstd(N_wEI,0) 
std_dict['N_Adfixed20_wDEI_rangeres1'] = np.nanstd(N_wDEI,0) 

#std_dict['N_Adfixed20_inh_hr'] = np.nanstd(N_wINH,0) 

#std_dict['N_Adfixed20_vt_EI8'] = np.nanstd(N_vt,0) #

D_mean_dict['N_Adfixed20_excboth_rangeres1wr'] = np.nanmean(D_exc,0) #
#D_mean_dict['N_Adfixed20_excd_rangeres'] = np.nanmean(D_excd,0) #
D_mean_dict['N_Adfixed20_excd_rangeres1'] = np.nanmean(D_excd1,0) #
#D_mean_dict['N_Adfixed20_excs_rangeres'] = np.nanmean(D_excs,0) #
D_mean_dict['N_Adfixed20_excs_rangeres1'] = np.nanmean(D_excs1,0) #

#Dp_mean_dict['N_Adfixed20_excd_rangeres'] = np.nanmean(Dp_excd,0) #
Dp_mean_dict['N_Adfixed20_excd_rangeres1'] = np.nanmean(Dp_excd1,0) #
Dp_mean_dict['N_Adfixed20_excs_rangeres1'] = np.nanmean(Dp_excs1,0) #

D_std_dict['N_Adfixed20_excboth_rangeres1wr'] = np.nanstd(D_exc,0)
#D_std_dict['N_Adfixed20_excd_rangeres'] = np.nanstd(D_excd,0)
#D_std_dict['N_Adfixed20_excs_rangeres'] = np.nanstd(D_excs,0)

#Dp_std_dict['N_Adfixed20_excd_rangeres'] = np.nanstd(Dp_excd,0)
Dp_std_dict['N_Adfixed20_excd_rangeres1'] = np.nanstd(Dp_excd1,0)
Dp_std_dict['N_Adfixed20_excs_rangeres1'] = np.nanstd(Dp_excs1,0)
D_std_dict['N_Adfixed20_excd_rangeres1'] = np.nanstd(D_excd1,0)
D_std_dict['N_Adfixed20_excs_rangeres1'] = np.nanstd(D_excs1,0)
...
#D_mean_dict['N_Adfixed20_etaboth_rangeres'] = np.nanmean(D_etaboth_rangeres,0)
...
#D_std_dict['N_Adfixed20_etaboth_rangeres'] = np.nanstd(D_etaboth_rangeres,0)
...
D_mean_dict['N_Adfixed20_wEI_rangeres1'] = np.nanmean(D_wEI,0) 
D_mean_dict['N_Adfixed20_wDEI_rangeres1'] = np.nanmean(D_wDEI,0) 
...
D_std_dict['N_Adfixed20_wEI_rangeres1'] = np.nanstd(D_wEI,0) 
D_std_dict['N_Adfixed20_wDEI_rangeres1'] = np.nanstd(D_wDEI,0) 
...
fig, (a1) = plt.subplots(1,1,figsize=(5,3))
j = 0
legendlabels = ['dendrite','dendritebAP']#,'eta','etad','etas','wEI','wDEI','vt']
#tsplot(a1,values_dict['N_Adfixed20_excd_rangeres'],mean_dict['N_Adfixed20_excd_rangeres'],std_dict['N_Adfixed20_excd_rangeres'],color='maroon')
tsplot(a1,values_dict['N_Adfixed20_excd_rangeres1'],mean_dict['N_Adfixed20_excd_rangeres1'],std_dict['N_Adfixed20_excd_rangeres1'],color='k')
#tsplot(a1,values_dict['N_Adfixed20_excboth_rangeres'],mean_dict['N_Adfixed20_excboth_rangeres'],std_dict['N_Adfixed20_excboth_rangeres'],color='gray')
...
plt.tight_layout()
#print('%s/tau_critical_means%s.pdf'%(savepath,identifier))
plt.savefig('%s/tau_critical_exc_comparebAP_means%s.pdf'%(savepath,identifier), bbox_extra_artists=(lgd,), bbox_inches='tight',format='pdf', transparent=True)

fig, (a1) = plt.subplots(1,1,figsize=(5,3))
j = 0
legendlabels = ['dendrite','soma']#,'eta','etad','etas','wEI','wDEI','vt']
tsplot(a1,values_dict['N_Adfixed20_excd_rangeres1'],mean_dict['N_Adfixed20_excd_rangeres1'],std_dict['N_Adfixed20_excd_rangeres1'],color='maroon')
tsplot(a1,values_dict['N_Adfixed20_excs_rangeres1'],mean_dict['N_Adfixed20_excs_rangeres1'],std_dict['N_Adfixed20_excs_rangeres1'],color='k')
...
plt.tight_layout()
#print('%s/tau_critical_means%s.pdf'%(savepath,identifier))
plt.savefig('%s/tau_critical_exc1_means%s.pdf'%(savepath,identifier), bbox_extra_artists=(lgd,), bbox_inches='tight',format='pdf', transparent=True)



#fig, (a1) = plt.subplots(1,1,figsize=(5,3))
#j = 0
#legendlabels = ['dendrite','soma', 'both']#,'eta','etad','etas','wEI','wDEI','vt']
#tsplot(a1,values_dict['N_Adfixed20_excd_rangeres'],mean_dict['N_Adfixed20_excd_rangeres'],std_dict['N_Adfixed20_excd_rangeres'],color='maroon')
#tsplot(a1,values_dict['N_Adfixed20_excs_rangeres'],mean_dict['N_Adfixed20_excs_rangeres'],std_dict['N_Adfixed20_excs_rangeres'],color='k')
#tsplot(a1,values_dict['N_Adfixed20_excboth_rangeres'],mean_dict['N_Adfixed20_excboth_rangeres'],std_dict['N_Adfixed20_excboth_rangeres'],color='gray')
...
#plt.tight_layout()
#print('%s/tau_critical_means%s.pdf'%(savepath,identifier))
#plt.savefig('%s/tau_critical_exc_means%s.pdf'%(savepath,identifier), bbox_extra_artists=(lgd,), bbox_inches='tight',format='pdf', transparent=True)


#fig, (a1) = plt.subplots(1,1,figsize=(5,3))
#j = 0
#legendlabels = ['dendrite','soma', 'both']#,'eta','etad','etas','wEI','wDEI','vt']
#a1.errorbar(values_dict['N_Adfixed20_excd_rangeres'],mean_dict['N_Adfixed20_excd_rangeres'], yerr=std_dict['N_Adfixed20_excd_rangeres'], fmt='-o', mfc = 'maroon')
#a1.errorbar(values_dict['N_Adfixed20_excs_rangeres'],mean_dict['N_Adfixed20_excs_rangeres'], yerr=std_dict['N_Adfixed20_excs_rangeres'], fmt='-^', mfc='k')
#tsplot(a1,values_dict['N_Adfixed20_excd_rangeres'],mean_dict['N_Adfixed20_excd_rangeres'],std_dict['N_Adfixed20_excd_rangeres'],color='maroon')
#tsplot(a1,values_dict['N_Adfixed20_excs_rangeres'],mean_dict['N_Adfixed20_excs_rangeres'],std_dict['N_Adfixed20_excs_rangeres'],color='k')
#tsplot(a1,values_dict['N_Adfixed20_excboth_rangeres'],mean_dict['N_Adfixed20_excboth_rangeres'],std_dict['N_Adfixed20_excboth_rangeres'],color='gray')
...
#plt.tight_layout()
#print('%s/tau_critical_means%s.pdf'%(savepath,identifier))
#plt.savefig('%s/tau_critical_errorbar_exc_means%s.pdf'%(savepath,identifier), bbox_extra_artists=(lgd,), bbox_inches='tight',format='pdf', transparent=True)

#print(np.shape(N_excd))
#plot_boxplot(N_excd,savepath,'dend')
#plot_boxplot(N_excs,savepath,'soma')

#fig, (a1) = plt.subplots(1,1,figsize=(5,3))
#j = 0
#legendlabels = ['dendrite','soma', 'both']#,'eta','etad','etas','wEI','wDEI','vt']
#tsplot(a1,values_dict['N_Adfixed20_excd_rangeres'],D_mean_dict['N_Adfixed20_excd_rangeres'],D_std_dict['N_Adfixed20_excd_rangeres'],color='maroon')
#tsplot(a1,values_dict['N_Adfixed20_excs_rangeres'],D_mean_dict['N_Adfixed20_excs_rangeres'],D_std_dict['N_Adfixed20_excs_rangeres'],color='k')
##tsplot(a1,values_dict['N_Adfixed20_excboth_rangeres'],D_mean_dict['N_Adfixed20_excboth_rangeres'],D_std_dict['N_Adfixed20_excboth_rangeres'],color='gray')
#lgd = plt.legend(legendlabels,bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.,frameon=False, framealpha=1)
#plt.xlabel('change in excitability')
...
j = 0
legendlabels = ['dendrite','soma']#,'eta','etad','etas','wEI','wDEI','vt']
tsplot(a1,values_dict['N_Adfixed20_excd_rangeres1'],D_mean_dict['N_Adfixed20_excd_rangeres1'],D_std_dict['N_Adfixed20_excd_rangeres1'],color='maroon')
tsplot(a1,values_dict['N_Adfixed20_excs_rangeres1'],D_mean_dict['N_Adfixed20_excs_rangeres1'],D_std_dict['N_Adfixed20_excs_rangeres1'],color='k')
#tsplot(a1,values_dict['N_Adfixed20_excboth_rangeres'],D_mean_dict['N_Adfixed20_excboth_rangeres'],D_std_dict['N_Adfixed20_excboth_rangeres'],color='gray')
lgd = plt.legend(legendlabels,bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.,frameon=False, framealpha=1)
plt.xlabel('change in excitability')
plt.ylabel('dendritic weight change [nS]')
...
plt.tight_layout()
print('%s/tau_critical_means%s.pdf'%(savepath,identifier))
plt.savefig('%s/dendweightchange_exc1_means%s.pdf'%(savepath,identifier), bbox_extra_artists=(lgd,), bbox_inches='tight',format='pdf', transparent=True)

fig, (a1) = plt.subplots(1,1,figsize=(5,3))
j = 0
legendlabels = ['dendrite','dendritebAP']#,'eta','etad','etas','wEI','wDEI','vt']
#tsplot(a1,values_dict['N_Adfixed20_excd_rangeres'],D_mean_dict['N_Adfixed20_excd_rangeres'],D_std_dict['N_Adfixed20_excd_rangeres'],color='maroon')
tsplot(a1,values_dict['N_Adfixed20_excd_rangeres1'],D_mean_dict['N_Adfixed20_excd_rangeres1'],D_std_dict['N_Adfixed20_excd_rangeres1'],color='k')
#tsplot(a1,values_dict['N_Adfixed20_excboth_rangeres'],D_mean_dict['N_Adfixed20_excboth_rangeres'],D_std_dict['N_Adfixed20_excboth_rangeres'],color='gray')
lgd = plt.legend(legendlabels,bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.,frameon=False, framealpha=1)
plt.xlabel('change in excitability')
plt.ylabel('dendritic weight change [nS]')
...
plt.tight_layout()
print('%s/tau_critical_means%s.pdf'%(savepath,identifier))
plt.savefig('%s/dendweightchange_exc_comparebAP_means%s.pdf'%(savepath,identifier), bbox_extra_artists=(lgd,), bbox_inches='tight',format='pdf', transparent=True)

fig, (a1) = plt.subplots(1,1,figsize=(5,3))
j = 0
legendlabels = ['dendrite','soma']#,'eta','etad','etas','wEI','wDEI','vt']
#tsplot(a1,values_dict['N_Adfixed20_excd_rangeres'],Dp_mean_dict['N_Adfixed20_excd_rangeres'],Dp_std_dict['N_Adfixed20_excd_rangeres'],color='maroon')
tsplot(a1,values_dict['N_Adfixed20_excs_rangeres1'],Dp_mean_dict['N_Adfixed20_excs_rangeres1'],Dp_std_dict['N_Adfixed20_excs_rangeres1'],color='k')
#tsplot(a1,values_dict['N_Adfixed20_excboth_rangeres'],D_mean_dict['N_Adfixed20_excboth_rangeres'],D_std_dict['N_Adfixed20_excboth_rangeres'],color='gray')
lgd = plt.legend(legendlabels,bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.,frameon=False, framealpha=1)
plt.xlabel('change in excitability')
plt.ylabel('dendritic weight change [nS]')
...
plt.tight_layout()
print('%s/tau_critical_means%s.pdf'%(savepath,identifier))
plt.savefig('%s/dendweightpot_exc1_means%s.pdf'%(savepath,identifier), bbox_extra_artists=(lgd,), bbox_inches='tight',format='pdf', transparent=True)
...
#j = 0
#legendlabels = ['dendrite','soma', 'both']#,'eta','etad','etas','wEI','wDEI','vt']
#tsplot(a1,values_dict['N_Adfixed20_etad_rangeres'],mean_dict['N_Adfixed20_etad_rangeres'],std_dict['N_Adfixed20_etad_rangeres'],color='maroon')
#tsplot(a1,values_dict['N_Adfixed20_etad_EI8highres'],mean_dict['N_Adfixed20_etad_EI8highres'],std_dict['N_Adfixed20_etad_EI8highres'])
#tsplot(a1,values_dict['N_Adfixed20_etas_rangeres'],mean_dict['N_Adfixed20_etas_rangeres'],std_dict['N_Adfixed20_etas_rangeres'],color='k')
#tsplot(a1,values_dict['N_Adfixed20_etaboth_rangeres'],mean_dict['N_Adfixed20_etaboth_rangeres'],std_dict['N_Adfixed20_etaboth_rangeres'],color='gray')
#
#lgd = plt.legend(legendlabels,bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.,frameon=False, framealpha=1)
#plt.xlabel('change in learning rate')
#plt.ylabel('tau critical [sec]')
...
#j = 0
#legendlabels = ['dendrite','soma', 'both']#,'eta','etad','etas','wEI','wDEI','vt']
#tsplot(a1,values_dict['N_Adfixed20_etad_rangeres'],D_mean_dict['N_Adfixed20_etad_rangeres'],D_std_dict['N_Adfixed20_etad_rangeres'],color='maroon')
#tsplot(a1,values_dict['N_Adfixed20_etas_rangeres'],D_mean_dict['N_Adfixed20_etas_rangeres'],D_std_dict['N_Adfixed20_etas_rangeres'],color='k')
##tsplot(a1,values_dict['N_Adfixed20_etaboth_rangeres'],D_mean_dict['N_Adfixed20_etaboth_rangeres'],D_std_dict['N_Adfixed20_etaboth_rangeres'],color='gray')
...
fig, (a1) = plt.subplots(1,1,figsize=(5,3))
j = 0
legendlabels = ['dendrite','soma','both']
...
tsplot(a1,values_dict['N_Adfixed20_wDEI_rangeres1'],mean_dict['N_Adfixed20_wDEI_rangeres1'],std_dict['N_Adfixed20_wDEI_rangeres1'],color='maroon')
tsplot(a1,values_dict['N_Adfixed20_wEI_rangeres1'],mean_dict['N_Adfixed20_wEI_rangeres1'],std_dict['N_Adfixed20_wEI_rangeres1'],color='k')
#tsplot(a1,values_dict['N_Adfixed20_inh_hr'],mean_dict['N_Adfixed20_inh_hr'],std_dict['N_Adfixed20_inh_hr'],color='gray')
...
tsplot(a1,values_dict['N_Adfixed20_wDEI_rangeres1'],D_mean_dict['N_Adfixed20_wDEI_rangeres1'],D_std_dict['N_Adfixed20_wDEI_rangeres1'],color='maroon')
tsplot(a1,values_dict['N_Adfixed20_wEI_rangeres1'],D_mean_dict['N_Adfixed20_wEI_rangeres1'],D_std_dict['N_Adfixed20_wEI_rangeres1'],color='k')
#tsplot(a1,values_dict['N_Adfixed20_inh_hr'],D_mean_dict['N_Adfixed20_inh_hr'],D_std_dict['N_Adfixed20_inh_hr'],color='gray')
...
x_values_etab, y_values_etab = interpolate(baseline_dend_weight_change_dict, values_dict, tau_critical_dict, ['N_Adfixed20_etaboth_rangeres1wr','N_Adfixed20_etaboth_rangeres1wr_s2','N_Adfixed20_etaboth_rangeres1wr_s3','N_Adfixed20_etaboth_rangeres1wr_s4','N_Adfixed20_etaboth_rangeres1wr_s5','N_Adfixed20_etaboth_rangeres1wr_s6','N_Adfixed20_etaboth_rangeres1wr_s7','N_Adfixed20_etaboth_rangeres1wr_s8','N_Adfixed20_etaboth_rangeres1wr_s9','N_Adfixed20_etaboth_rangeres1wr_s10'])

x_values_vt, y_values_vt = interpolate(baseline_dend_weight_change_dict, values_dict, tau_critical_dict, ['N_Adfixed20_vt_rangeres1wr','N_Adfixed20_vt_rangeres1wr_s2','N_Adfixed20_vt_rangeres1wr_s3','N_Adfixed20_vt_rangeres1wr_s4','N_Adfixed20_vt_rangeres1wr_s5','N_Adfixed20_vt_rangeres1wr_s6','N_Adfixed20_vt_rangeres1wr_s7','N_Adfixed20_vt_rangeres1wr_s8','N_Adfixed20_vt_rangeres1wr_s9','N_Adfixed20_vt_rangeres1wr_s10'], flip = True)#,'N_Adfixed20_vt_rangeres1wr_s5','N_Adfixed20_vt_rangeres1wr_s6','N_Adfixed20_vt_rangeres1wr_s7','N_Adfixed20_vt_rangeres1wr_s8'], flip=True)#,'N_Adfixed20_vt_rangeres_s5','N_Adfixed20_vt_rangeres_s6'])
...
x_values_excb, y_values_excb = interpolate(baseline_dend_weight_change_dict, values_dict, tau_critical_dict, ['N_Adfixed20_excboth_rangeres1wr_s2','N_Adfixed20_excboth_rangeres1wr','N_Adfixed20_excboth_rangeres1wr_s3','N_Adfixed20_excboth_rangeres1wr_s4','N_Adfixed20_excboth_rangeres1wr_s5','N_Adfixed20_excboth_rangeres1wr_s6','N_Adfixed20_excboth_rangeres1wr_s7','N_Adfixed20_excboth_rangeres1wr_s8','N_Adfixed20_excboth_rangeres1wr_s9','N_Adfixed20_excboth_rangeres1wr_s10'])
...
x_values_inhb, y_values_inhb = interpolate(baseline_dend_weight_change_dict, values_dict, tau_critical_dict, ['N_Adfixed20_inhboth_rangeres1wr','N_Adfixed20_inhboth_rangeres1wr_s2','N_Adfixed20_inhboth_rangeres1wr_s3','N_Adfixed20_inhboth_rangeres1wr_s4','N_Adfixed20_inhboth_rangeres1wr_s5','N_Adfixed20_inhboth_rangeres1wr_s6','N_Adfixed20_inhboth_rangeres1wr_s7','N_Adfixed20_inhboth_rangeres1wr_s8','N_Adfixed20_inhboth_rangeres1wr_s9','N_Adfixed20_inhboth_rangeres1wr_s10'], flip = True)#'N_Adfixed20_inhboth_rangeres_s5','N_Adfixed20_inhboth_rangeres_s6','N_Adfixed20_inhboth_rangeres_s7','N_Adfixed20_inhboth_rangeres_s8'], flip=True)

fig, (a1) = plt.subplots(1,1,figsize=(5,3))
j = 0
legendlabels = ['learning rate','excitability','intrinsic excitability','inhibition']
...
tsplot(a1,x_values_excb,np.mean(np.array(y_values_excb),0),np.std(np.array(y_values_excb),0),color=cmaps.viridis(.2))
tsplot(a1,x_values_vt,np.mean(np.array(y_values_vt),0),np.std(np.array(y_values_vt),0),color=cmaps.magma(.7))
...
fig, (a1) = plt.subplots(1,1,figsize=(5,3))
j = 0
legendlabels = ['learning rate','excitability','inhibition']
...
fig, (a1) = plt.subplots(1,1,figsize=(5,3))
j = 0
legendlabels = ['learning rate','excitability','inhibition']#,'vt']
conditions = ['N_Adfixed20_etas_EI8','N_Adfixed20_excs_EI8','N_Adfixed20_wEI_EI8']#,'N_Adfixed20_vt_EI8']
for key in conditions:
    tsplot(a1,baseline_dend_weight_change_dict[key],mean_dict[key],std_dict[key])
lgd = plt.legend(legendlabels,bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.,frameon=False, framealpha=1)
plt.xlabel('dendritic weight change baseline')
